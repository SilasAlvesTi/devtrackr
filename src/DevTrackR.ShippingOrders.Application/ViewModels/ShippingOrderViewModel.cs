...
namespace DevTrackR.ShippingOrders.Application.ViewModels
{
    ...
    {
        public ShippingOrderViewModel(string trackingCode, string description, DateTime postedAt, decimal weitghtInKg, string fullAddress)
        {
            TrackingCode = trackingCode;
            Description = description;
            PostedAt = postedAt;
            WeitghtInKg = weitghtInKg;
        ...
        public decimal WeitghtInKg { get; private set; }
